...
@include('admin.layout.aside')
    ...
    <div style="margin-top:20px;" class="ui breadcrumb">
        ...
        <div class="section">Best Selling Reports</div>
    </div>
    <h1 class=""> Best Selling Reports</h1>
            <!--<button id='btnprint' class='ui primary button' > Print Table </button>-->
            <a href="{{url('admin/bestselling')}}" class='ui red button'> Clear Filter </a>
...
<script>
    $(document).ready(function(){
        ...
        data: (<?php echo ($best);?>)
             ...
             dataSource = {
        chart: {
            caption: "Best Selling Product from "+ from + " to "+ to,
            yaxisname: "Number of Purchases",
            aligncaptionwithcanvas: "0",
            plottooltext: "<b>$dataValue</b> purchases",
            theme: "fusion",
