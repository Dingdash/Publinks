            ...
            <div class="ui grid centered">
                ...
                <div class="ui column lg:max-w-lg sm:mx-4 md:max-w-lg">
                    ...
                    <div class="shadow-md bg-white p-4">
                            ...
                            <div class="mb-4"></div>
                            <form id='formupload' class="ui form" method="POST" enctype="multipart/form-data" action="{{url('/createpdf')}}">
                                {{csrf_field()}}  
                                   {{-- <input type="hidden" name="uID" value="{{session('user')->user_id}}"> --}}
                                    ...
                                    <div class="required field">
                                        <label>TITLE</label>
                                        <input required name="title" type="text" placeholder="Book Title">
                                    </div>
                                    <div class="required field">
